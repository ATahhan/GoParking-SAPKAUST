...
public class OnboardingFlowProvider: OnboardingFlowProviding {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: "com.dcoders.goparking", authenticationPath: "Parking")
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            welcomeStepUI.headlineLabel.text = "com.dcoders.goparking"
            ...
            if let welcomeScreen = welcomeStepUI as? FUIWelcomeScreen {
                ...
                welcomeScreen.emailTextField.text = "user@trial-p2001088143trial.sapmobileplace.com"
            }
        }
